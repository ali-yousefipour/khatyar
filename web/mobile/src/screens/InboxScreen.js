...
const s = StyleSheet.create({
  ...
  chipsRow: { flexDirection: 'row-reverse', gap: 6, paddingHorizontal: 12, paddingVertical: 8 },
  chip: { backgroundColor: '#fff', borderColor: C.line, borderWidth: 1, borderRadius: 99, paddingVertical: 6, paddingHorizontal: 12 },
