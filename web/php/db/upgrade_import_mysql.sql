...
-- آموزش مدل OCR مبتنی بر Python از سامانه حذف شده (تشخیص پلاک روی گوشی با
-- ML Kit انجام می‌شود)؛ جدول قدیمی plate_model_runs در صورت وجود پاک می‌شود.
DROP TABLE IF EXISTS plate_model_runs;
