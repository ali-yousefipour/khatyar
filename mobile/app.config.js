...
module.exports = ({ config }) => ({
  ...
  slug: 'khatyar-mobile',
  version: process.env.ANDROID_VERSION_NAME || '1.3.71',
  ...
  android: {
    ...
    versionCode: Number(process.env.ANDROID_VERSION_CODE || 10371),
  ...
  extra: { defaultApiBase: process.env.API_BASE || 'https://app.yousefipour.ir/api', enableBgTracking: (process.env.ENABLE_BG_TRACKING || 'true') === 'true', app_version: process.env.ANDROID_VERSION_NAME || '1.3.71', eas: { projectId: process.env.EAS_PROJECT_ID || '' } },
});
