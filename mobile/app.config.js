...
module.exports = ({ config }) => ({
  ...
  slug: 'khatyar-mobile',
  version: process.env.ANDROID_VERSION_NAME || '1.3.67',
  ...
  android: {
    ...
    versionCode: Number(process.env.ANDROID_VERSION_CODE || 10367),
  ...
  extra: {
    ...
    app_version: process.env.ANDROID_VERSION_NAME || '1.3.67',
