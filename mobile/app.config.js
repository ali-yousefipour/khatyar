...
module.exports = ({ config }) => ({
  ...
  android: {
    ...
    permissions: ['ACCESS_FINE_LOCATION','ACCESS_COARSE_LOCATION','ACCESS_BACKGROUND_LOCATION','CAMERA','RECORD_AUDIO','INTERNET','ACCESS_NETWORK_STATE','FOREGROUND_SERVICE','FOREGROUND_SERVICE_LOCATION','RECEIVE_BOOT_COMPLETED','VIBRATE','WAKE_LOCK','REQUEST_IGNORE_BATTERY_OPTIMIZATIONS'],
  },
  plugins: [
    ...
    ['expo-audio',{microphonePermission:'برای استفاده از بی‌سیم خطیار، دسترسی میکروفون لازم است.',recordAudioAndroid:true,enableBackgroundPlayback:true,enableBackgroundRecording:false}],
    'expo-camera',
