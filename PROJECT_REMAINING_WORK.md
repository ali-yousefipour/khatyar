...
- 🟢 ثبت ایستگاه از دوربین و GPS با High Accuracy پیاده‌سازی شده است.
...
- 🟢 لایه `web-android-parity-v2.js` به نسخه 3 ارتقا یافت.
- 🟢 ترتیب کارت‌ها و دسته‌بندی امکانات مطابق MENU Android شد.
- 🟢 ظاهر کارت‌ها، فاصله‌ها، RTL و responsive behavior همسان‌سازی شد.
- 🟢 تصاویر ایستگاه فقط با Camera UI گرفته می‌شوند؛ Gallery UI نمایش داده نمی‌شود.
- 🟢 Preview تصاویر محدود و contain شده است.
...
- 🟡 تطبیق صفحه مدیریت Permission با مدل مرکزی دسترسی.
- 🟡 قرارگیری تنظیم `can_capture/can_view/can_manage` در تنظیمات مرتبط.
- 🟡 ادغام کامل نمایش اطلاعات ایستگاه در بخش «خطوط تاکسیرانی».
...
## 8. فرآیند اجباری ثبت تغییرات

هر قابلیت جدید یا اصلاح باید، در صورت ارتباط، همزمان در این موارد ثبت شود:
1. Android
2. Web App
3. Site/Admin
4. Backend/API
