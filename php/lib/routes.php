...
route('GET','/api/school-service/meta',function($p,$b,$u){_ssv_need($u,'view');_ssv_tables();return ['districts'=>['۱','۲','۳','۴','۵','۶','۷','تبادکان'],'genders'=>['دخترانه','پسرانه','دخترانه-پسرانه','نامشخص'],'driver_genders'=>['خانم','آقا','نامشخص'],'vehicle_types'=>['سمند','سورن','پژو','پراید','تیبا','دنا','رانا','اطلس','کوییک','سایر'],'vehicle_colors'=>['سفید','زرد','مشکی','نقره‌ای','خاکستری','آبی','قرمز','سبز','سایر'],'violations'=>Db::all("SELECT id,title FROM school_service_violation_types WHERE is_active=1 ORDER BY sort_order,id")];});
