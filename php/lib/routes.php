...
const SITE_VERSION = '1.4.9';   // نسخهٔ سایت — همیشه با نسخهٔ اپ و نام فایل پروژه یکی است
const APP_VERSION = '1.4.9'; // نسخهٔ اپ اندروید — با هر تغییر افزایش می‌یابد
