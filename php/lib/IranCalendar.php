<?php
/* خطیار — تقویم رسمی ایران ۱۴۰۵
 * تعطیلات رسمی و مناسبت‌ها منبع مستقل از جدول holidays هستند.
 * جدول holidays فقط برای تعطیلات دستی سازمان استفاده می‌شود.
 */
class IranCalendar
{
    private static $years = [
        1405 => [
            '01-01'=>'آغاز نوروز',
            '01-02'=>'عید سعید فطر - تعطیل به مناسبت عید نوروز',
            '01-03'=>'عید نوروز',
            '01-04'=>'عید نوروز',
            ...
            '10-02'=>'ولادت امام علی (ع) و روز پدر',
    ...
    {
        $d = self::normalize($jdate);
        if (!$d) return ['is_official_holiday'=>false,'title'=>null];
        return ['is_official_holiday'=>self::isOfficialHoliday($d),'title'=>self::title($d)];
    }
}
