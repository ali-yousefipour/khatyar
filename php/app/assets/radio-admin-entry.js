...
function isAllowed(settings){const id=roleId();if(id==null)return false;const p=settings&&settings.role_perms||{};const list=p[String(id)]??p[id];return Array.isArray(list)&&(list.includes('radio')||list.includes('radiocenter'))}
