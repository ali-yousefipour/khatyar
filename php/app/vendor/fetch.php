 ...
 * یک‌بار این آدرس را در مرورگر باز کنید:  https://app.yousefipour.ir/vendor/fetch.php
...
if ($fail === 0) {
  echo "<p>حالا پنل بدون اینترنت جهانی کار می‌کند. <b>این فایل (fetch.php) را پس از اطمینان حذف کنید.</b></p>";
} else {
