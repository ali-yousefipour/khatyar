...
$tag = '<script src="assets/android-web-parity.js?v=20260904" defer></script><script src="assets/android-web-existing-screen-parity.js?v=20260904" defer></script>';
if (strpos($html, 'android-web-parity.js') === false) {
    ...
    $html = preg_replace('/<\/body>/i', '<script src="assets/android-web-existing-screen-parity.js?v=20260904" defer></script>' . "\n</body>", $html, 1);
}
